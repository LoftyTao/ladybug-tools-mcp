...
def register(mcp: FastMCP) -> None:
    """Register the dragonfly_building_to_visualization_set tool."""

    @mcp.tool(
        name="building_to_visualization_set",
        description=(
            ...
            "visualization_set_to_svg or visualization_set_to_vtkjs. Returns "
