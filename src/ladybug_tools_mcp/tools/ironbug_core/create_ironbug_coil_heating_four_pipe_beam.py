'MCP tool for IB_coil_heating_four_pipe_beam.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_heating_four_pipe_beam tool.'

    @mcp.tool(
        name='IB_coil_heating_four_pipe_beam',
        description=(
            ...
            'IB_air_terminal_single_duct_constant_volume_four_pipe_beam. '
