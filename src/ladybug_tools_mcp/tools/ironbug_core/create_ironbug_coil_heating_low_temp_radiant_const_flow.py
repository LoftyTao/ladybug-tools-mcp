'MCP tool for IB_coil_heating_low_temp_radiant_const_flow.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_heating_low_temp_radiant_const_flow tool.'

    @mcp.tool(
        name='IB_coil_heating_low_temp_radiant_const_flow',
        description=(
