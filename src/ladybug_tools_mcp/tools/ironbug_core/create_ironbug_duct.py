...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'air-loop', 'duct', 'author'},
        timeout=20,
    )
    def create_ironbug_duct(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable DetailedHVAC object identifier for this air-loop duct component."),
        ],
        ...
        name: Annotated[
            str | None,
            Field(
                description="Optional EnergyPlus/OpenStudio Duct object name; defaults to the identifier when omitted."
            ),
        ] = None,
