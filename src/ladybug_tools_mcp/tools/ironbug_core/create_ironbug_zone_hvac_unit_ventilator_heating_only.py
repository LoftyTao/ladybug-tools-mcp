'MCP tool for IB_zone_equipment_unit_ventilator_heating_only.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_zone_equipment_unit_ventilator_heating_only tool.'

    @mcp.tool(
        name='IB_zone_equipment_unit_ventilator_heating_only',
        description=(
