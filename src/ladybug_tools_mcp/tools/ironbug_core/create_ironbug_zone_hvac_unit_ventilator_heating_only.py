'MCP tool for detailed_hvac_zone_equipment_unit_ventilator_heating_only.'
...
def register(mcp: FastMCP) -> None:
    'Register the detailed_hvac_zone_equipment_unit_ventilator_heating_only tool.'

    @mcp.tool(
        name='zone_equipment_unit_ventilator_heating_only',
        description=(
            'Create IB_ZoneHVACUnitVentilator_HeatingOnly, the Ironbug and EnergyPlus ZoneHVAC:UnitVentilator variant with a heating coil, fan, outdoor-air controls, and optional ThermalZone placement. Use it for room-level heating-only unit ventilators, not as a unit heater, fan coil, air terminal, standalone coil, or result reader. Returns target, summary_view, persistence_receipt, and report for downstream DetailedHVAC assembly.'
            'This tool authors Ironbug DetailedHVAC input only; run Energy simulation with the standard Ladybug Tools MCP Energy workflow after DetailedHVAC is applied. '
        ),
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'zone-equipment', 'unit-ventilator', 'heating', 'fan', 'outdoor-air', 'thermal-zone', 'author'},
        timeout=20,
    )
    def create_ironbug_zone_hvac_unit_ventilator_heating_only(
        garden_root: Annotated[
            str,
            Field(description="Garden root containing garden.json where the Ironbug model and created heating-only unit ventilator are stored."),
        ],
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_ZoneHVACUnitVentilator_HeatingOnly object."),
        ],
        ...
        outdoor_air_control_type: Annotated[
            str | None,
            Field(description='Optional OutdoorAirControlType value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field OutdoorAirControlType. EnergyPlus accepts VariablePercent, FixedTemperature, or FixedAmount.'),
        ] = None,
        minimum_outdoor_air_flow_rate: Annotated[
            float | str | None,
            Field(description='Optional MinimumOutdoorAirFlowRate value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field MinimumOutdoorAirFlowRate.'),
        ] = None,
        minimum_outdoor_air_schedule_target: Annotated[
            dict[str, Any] | str | None,
            Field(description='Optional Ironbug object target for MinimumOutdoorAirSchedule; pass a target dict from a compatible create_ironbug_* tool or a same-model identifier. Maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field MinimumOutdoorAirSchedule (IB_Schedule).'),
        ] = None,
        maximum_outdoor_air_flow_rate: Annotated[
            float | str | None,
            Field(description='Optional MaximumOutdoorAirFlowRate value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field MaximumOutdoorAirFlowRate.'),
        ] = None,
        maximum_outdoor_air_fractionor_temperature_schedule_target: Annotated[
            dict[str, Any] | str | None,
            Field(description='Optional Ironbug object target for MaximumOutdoorAirFractionorTemperatureSchedule; pass a target dict from a compatible create_ironbug_* tool or a same-model identifier. Maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field MaximumOutdoorAirFractionorTemperatureSchedule (IB_Schedule).'),
        ] = None,
        supply_air_fan_operating_mode_schedule_target: Annotated[
            dict[str, Any] | str | None,
            Field(description='Optional Ironbug object target for SupplyAirFanOperatingModeSchedule; pass a target dict from a compatible create_ironbug_* tool or a same-model identifier. Maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field SupplyAirFanOperatingModeSchedule (IB_Schedule).'),
        ] = None,
        heating_convergence_tolerance: Annotated[
            float | None,
            Field(description='Optional HeatingConvergenceTolerance value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field HeatingConvergenceTolerance.'),
        ] = None,
        cooling_convergence_tolerance: Annotated[
            float | None,
            Field(description='Optional CoolingConvergenceTolerance value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field CoolingConvergenceTolerance.'),
        ] = None,
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_ZoneHVACUnitVentilator_HeatingOnly field Name.'),
        ] = None,
        ...
        """Create an Ironbug ZoneHVAC:UnitVentilator heating-only object."""
        ...
        if any(item is not None for item in child_targets) and not all(
            ...
            raise ValueError(
                ...
                "be provided together for unit ventilator heating-only child binding."
            )
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_ZoneHVACUnitVentilator_HeatingOnly',
        ...
        if all(item is not None for item in child_targets):
            children = set_ironbug_unit_ventilator_heating_only_children(
                garden_root=garden_root,
