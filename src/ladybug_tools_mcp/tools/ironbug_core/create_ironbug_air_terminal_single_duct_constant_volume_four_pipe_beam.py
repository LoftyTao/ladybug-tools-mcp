'MCP tool for IB_air_terminal_single_duct_constant_volume_four_pipe_beam.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_air_terminal_single_duct_constant_volume_four_pipe_beam tool.'

    @mcp.tool(
        name='IB_air_terminal_single_duct_constant_volume_four_pipe_beam',
        description=(
        ...
        cooling_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "IB_coil_cooling_four_pipe_beam target."
                )
            ),
        ] = None,
        heating_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "IB_coil_heating_four_pipe_beam target."
                )
            ),
        ] = None,
        overwrite: Annotated[
