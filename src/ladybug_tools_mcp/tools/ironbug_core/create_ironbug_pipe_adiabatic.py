...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'plant-loop', 'plant-component', 'pipe', 'adiabatic-pipe', 'bypass', 'author'},
        timeout=20,
    )
    def create_ironbug_pipe_adiabatic(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_PipeAdiabatic object."),
        ],
        ...
        name: Annotated[
            str | None,
            Field(
                description="Optional EnergyPlus object name for this Pipe:Adiabatic connector or bypass; maps to Name."
            ),
        ] = None,
