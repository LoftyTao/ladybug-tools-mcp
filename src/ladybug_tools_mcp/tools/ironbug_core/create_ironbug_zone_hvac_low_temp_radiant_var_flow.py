'MCP tool for IB_zone_equipment_low_temp_radiant_var_flow.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_zone_equipment_low_temp_radiant_var_flow tool.'

    @mcp.tool(
        name='IB_zone_equipment_low_temp_radiant_var_flow',
        description=(
