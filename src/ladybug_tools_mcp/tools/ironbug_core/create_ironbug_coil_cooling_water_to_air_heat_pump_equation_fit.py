'MCP tool for IB_coil_cooling_water_to_air_heat_pump_equation_fit.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_cooling_water_to_air_heat_pump_equation_fit tool.'

    @mcp.tool(
        name='IB_coil_cooling_water_to_air_heat_pump_equation_fit',
        description=(
