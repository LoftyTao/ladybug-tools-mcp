'MCP tool for IB_coil_water_heating_air_to_water_heat_pump.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_water_heating_air_to_water_heat_pump tool.'

    @mcp.tool(
        name='IB_coil_water_heating_air_to_water_heat_pump',
        description=(
