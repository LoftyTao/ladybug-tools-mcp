'MCP tool for IB_setpoint_manager_system_node_reset_humidity.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_setpoint_manager_system_node_reset_humidity tool.'

    @mcp.tool(
        name='IB_setpoint_manager_system_node_reset_humidity',
        description=(
