'MCP tool for IB_coil_cooling_cooled_beam.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_cooling_cooled_beam tool.'

    @mcp.tool(
        name='IB_coil_cooling_cooled_beam',
        description=(
            ...
            'IB_air_terminal_single_duct_constant_volume_cooled_beam. '
