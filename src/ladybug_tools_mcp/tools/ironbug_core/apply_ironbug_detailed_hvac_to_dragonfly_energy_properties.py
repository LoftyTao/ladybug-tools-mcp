...
def register(mcp: FastMCP) -> None:
    'Register the IB_apply_to_dragonfly_energy_properties tool.'

    @mcp.tool(
        name="IB_apply_to_dragonfly_energy_properties",
        description=(
            ...
            'ironbug_model_target from IB_create_model and host_target from '
            'DF_search_objects or Dragonfly create tools. Room2D uses '
