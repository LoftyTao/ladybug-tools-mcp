...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'availability-manager', 'control', 'temperature', 'schedule', 'air-loop', 'plant-loop', 'hvac', 'author'},
        timeout=20,
    )
    def create_ironbug_availability_manager_low_temperature_turn_off(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_AvailabilityManagerLowTemperatureTurnOff object."),
        ],
        ...
        temperature: Annotated[
            float | None,
            Field(description='Optional low-temperature turn-off threshold; maps to Ironbug IB_AvailabilityManagerLowTemperatureTurnOff field Temperature.'),
        ] = None,
        applicability_schedule_target: Annotated[
            dict[str, Any] | str | None,
            Field(description='Optional Ironbug object target for ApplicabilitySchedule; pass a target dict from a compatible create_ironbug_* tool or a same-model identifier. Maps to Ironbug IB_AvailabilityManagerLowTemperatureTurnOff field ApplicabilitySchedule (IB_Schedule).'),
        ] = None,
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_AvailabilityManagerLowTemperatureTurnOff field Name.'),
        ] = None,
        ...
        sensor_probe_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "on IB_AvailabilityManagerLowTemperatureTurnOff."
                )
            ),
        ] = None,
        overwrite: Annotated[
        ...
        return create_source_backed_ironbug_object(
            ...
            source_class='IB_AvailabilityManagerLowTemperatureTurnOff',
