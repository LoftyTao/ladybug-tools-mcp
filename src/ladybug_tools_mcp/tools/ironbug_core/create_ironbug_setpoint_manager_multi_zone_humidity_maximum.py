'MCP tool for IB_setpoint_manager_multi_zone_humidity_maximum.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_setpoint_manager_multi_zone_humidity_maximum tool.'

    @mcp.tool(
        name='IB_setpoint_manager_multi_zone_humidity_maximum',
        description=(
