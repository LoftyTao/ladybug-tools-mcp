'MCP tool for IB_setpoint_manager_follow_ground_temperature.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_setpoint_manager_follow_ground_temperature tool.'

    @mcp.tool(
        name='IB_setpoint_manager_follow_ground_temperature',
        description=(
