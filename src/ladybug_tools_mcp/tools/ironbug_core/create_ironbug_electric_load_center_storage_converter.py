'MCP tool for IB_electric_load_center_storage_converter.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_electric_load_center_storage_converter tool.'

    @mcp.tool(
        name='IB_electric_load_center_storage_converter',
        description=(
