...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'zone-equipment', 'baseboard', 'radiant', 'convective', 'hot-water', 'heating', 'thermal-zone', 'plant-loop', 'author'},
        timeout=20,
    )
    def create_ironbug_zone_hvac_baseboard_radiant_convective_water(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_ZoneHVACBaseboardRadiantConvectiveWater object."),
        ],
        ...
        fractionof_radiant_energy_incidenton_people: Annotated[
            float | None,
            Field(description='Optional FractionofRadiantEnergyIncidentonPeople value; maps to Ironbug IB_ZoneHVACBaseboardRadiantConvectiveWater field FractionofRadiantEnergyIncidentonPeople.'),
        ] = None,
        ...
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_ZoneHVACBaseboardRadiantConvectiveWater field Name.'),
        ] = None,
        ...
        coil_heating_water_baseboard_radiant_target: Annotated[
            dict[str, Any] | str | None,
            Field(
                description=(
                    "Optional IB_CoilHeatingWaterBaseboardRadiant target for the hot-water "
                    "radiant-convective baseboard coil child."
                )
            ),
        ] = None,
        overwrite: Annotated[
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_ZoneHVACBaseboardRadiantConvectiveWater',
