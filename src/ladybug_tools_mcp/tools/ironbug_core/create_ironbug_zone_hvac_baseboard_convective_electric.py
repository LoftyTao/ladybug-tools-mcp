...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'zone-equipment', 'baseboard', 'convective', 'electric', 'heating', 'thermal-zone', 'author'},
        timeout=20,
    )
    def create_ironbug_zone_hvac_baseboard_convective_electric(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_ZoneHVACBaseboardConvectiveElectric object."),
        ],
        ...
        nominal_capacity: Annotated[
            float | str | None,
            Field(description='Optional electric baseboard nominal heating capacity in W, or autosize text accepted by the source field.'),
        ] = None,
        efficiency: Annotated[
            float | None,
            Field(description='Optional Efficiency value; maps to Ironbug IB_ZoneHVACBaseboardConvectiveElectric field Efficiency.'),
        ] = None,
        ...
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_ZoneHVACBaseboardConvectiveElectric field Name.'),
        ] = None,
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_ZoneHVACBaseboardConvectiveElectric',
