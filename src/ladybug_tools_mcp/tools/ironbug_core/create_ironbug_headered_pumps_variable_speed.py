'MCP tool for detailed_hvac_headered_pumps_variable_speed.'
...
def register(mcp: FastMCP) -> None:
    'Register the detailed_hvac_headered_pumps_variable_speed tool.'

    @mcp.tool(
        name='headered_pumps_variable_speed',
        description=(
            'Create an Ironbug IB_HeaderedPumpsVariableSpeed component for an EnergyPlus/OpenStudio HeaderedPumps:VariableSpeed pump bank on a plant or condenser loop. Use this for multiple variable-speed pumps in parallel with total design flow, sequencing, minimum-flow fraction, and part-load coefficients. This authors Ironbug DetailedHVAC input only; run Energy simulation after the DetailedHVAC system is applied. Returns target, summary_view, persistence_receipt, and report.'
    ...
    def create_ironbug_headered_pumps_variable_speed(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable DetailedHVAC object identifier for this variable-speed headered pump bank."),
        ],
        ...
        coefficient1ofthe_part_load_performance_curve_target: Annotated[
            ...
            Field(description="Optional IB_Curve target or same-model identifier for coefficient 1 of the pump-bank part-load performance curve."),
        ] = None,
        coefficient2ofthe_part_load_performance_curve_target: Annotated[
            dict[str, Any] | str | None,
            Field(description="Optional IB_Curve target or same-model identifier for coefficient 2 of the pump-bank part-load performance curve."),
        ] = None,
        coefficient3ofthe_part_load_performance_curve_target: Annotated[
            dict[str, Any] | str | None,
            Field(description="Optional IB_Curve target or same-model identifier for coefficient 3 of the pump-bank part-load performance curve."),
        ] = None,
        coefficient4ofthe_part_load_performance_curve_target: Annotated[
            dict[str, Any] | str | None,
            Field(description="Optional IB_Curve target or same-model identifier for coefficient 4 of the pump-bank part-load performance curve."),
        ] = None,
        minimum_flow_rate_fraction: Annotated[
            float | None,
            Field(description="Optional minimum flow rate fraction for the variable-speed pump bank, from 0 to 1."),
        ] = None,
        ...
        """Create IB_HeaderedPumpsVariableSpeed as a reviewed Ironbug Loop Objs authoring object."""
        ...
        if minimum_flow_rate_fraction is not None:
            source_fields['MinimumFlowRateFraction'] = minimum_flow_rate_fraction
        ...
        return create_source_backed_ironbug_object(
            ...
            source_class='IB_HeaderedPumpsVariableSpeed',
