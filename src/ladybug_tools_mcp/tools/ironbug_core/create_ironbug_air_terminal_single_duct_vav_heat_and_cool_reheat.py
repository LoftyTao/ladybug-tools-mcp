'MCP tool for IB_air_terminal_single_duct_vav_heat_and_cool_reheat.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_air_terminal_single_duct_vav_heat_and_cool_reheat tool.'

    @mcp.tool(
        name='IB_air_terminal_single_duct_vav_heat_and_cool_reheat',
        description=(
        ...
        heating_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "heat-and-cool reheat terminal; use an IB_coil_heating_* target."
                )
            ),
        ] = None,
        overwrite: Annotated[
