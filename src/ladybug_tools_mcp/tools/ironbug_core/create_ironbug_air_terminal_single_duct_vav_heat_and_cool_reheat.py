'MCP tool for detailed_hvac_air_terminal_single_duct_vav_heat_and_cool_reheat.'
...
def register(mcp: FastMCP) -> None:
    'Register the detailed_hvac_air_terminal_single_duct_vav_heat_and_cool_reheat tool.'

    @mcp.tool(
        name='air_terminal_single_duct_vav_heat_and_cool_reheat',
        description=(
            'Create IB_AirTerminalSingleDuctVAVHeatAndCoolReheat, an Ironbug '
            'single-duct variable air volume (VAV) heat-and-cool reheat air '
            'terminal that maps downstream to EnergyPlus/OpenStudio '
            'AirTerminal:SingleDuct:VAV:HeatAndCool:Reheat. Use the returned '
            'target as a demand-side terminal unit, attach a compatible '
            'heating coil child target when needed, and bind it to an '
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'air-terminal', 'terminal-unit', 'single-duct', 'vav', 'heating', 'cooling', 'reheat', 'thermal-zone', 'author'},
        timeout=20,
    )
    def create_ironbug_air_terminal_single_duct_vav_heat_and_cool_reheat(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_AirTerminalSingleDuctVAVHeatAndCoolReheat object."),
        ],
        ...
        availability_schedule_target: Annotated[
            ...
            Field(description='Optional IB_Schedule target for AvailabilitySchedule; pass a target dict from a compatible detailed_hvac schedule tool or a same-model identifier. Schedule values above zero make the VAV heat-and-cool reheat terminal available.'),
        ] = None,
        ...
        maximum_reheat_air_temperature: Annotated[
            float | None,
            Field(description='Optional MaximumReheatAirTemperature in degrees C for the VAV heat-and-cool reheat terminal.'),
        ] = None,
        ...
        thermal_zone_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "bind this VAV heat-and-cool reheat air terminal to after "
        ...
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_AirTerminalSingleDuctVAVHeatAndCoolReheat field Name.'),
        ] = None,
        ...
        heating_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "identifier for Parameter 'HeatingCoil' on the VAV "
                    "heat-and-cool reheat terminal; use a detailed_hvac_coil_heating_* target."
                )
            ),
        ] = None,
        overwrite: Annotated[
        ...
        """Create IB_AirTerminalSingleDuctVAVHeatAndCoolReheat as a reviewed reheat air terminal."""
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_AirTerminalSingleDuctVAVHeatAndCoolReheat',
