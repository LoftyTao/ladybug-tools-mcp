'MCP tool for IB_setpoint_manager_multi_zone_heating_average.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_setpoint_manager_multi_zone_heating_average tool.'

    @mcp.tool(
        name='IB_setpoint_manager_multi_zone_heating_average',
        description=(
