...
def register(mcp: FastMCP) -> None:
    ...
    def create_ironbug_setpoint_manager_multi_zone_minimum_humidity_average(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_SetpointManagerMultiZoneMinimumHumidityAverage object."),
        ],
        ...
        name: Annotated[
            str | None,
            Field(description='Optional EnergyPlus/OpenStudio object name; maps to Ironbug IB_SetpointManagerMultiZoneMinimumHumidityAverage field Name.'),
        ] = None,
        overwrite: Annotated[
            bool,
        ...
        return create_source_backed_ironbug_object(
            ...
            source_class='IB_SetpointManagerMultiZoneMinimumHumidityAverage',
