'MCP tool for IB_electric_load_center_inverter_pv_watts.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_electric_load_center_inverter_pv_watts tool.'

    @mcp.tool(
        name='IB_electric_load_center_inverter_pv_watts',
        description=(
