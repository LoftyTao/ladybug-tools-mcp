'MCP tool for IB_electric_load_center_inverter_simple.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_electric_load_center_inverter_simple tool.'

    @mcp.tool(
        name='IB_electric_load_center_inverter_simple',
        description=(
