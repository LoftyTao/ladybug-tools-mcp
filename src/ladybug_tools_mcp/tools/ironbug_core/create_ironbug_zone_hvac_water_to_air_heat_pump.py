'MCP tool for IB_zone_equipment_water_to_air_heat_pump.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_zone_equipment_water_to_air_heat_pump tool.'

    @mcp.tool(
        name='IB_zone_equipment_water_to_air_heat_pump',
        description=(
