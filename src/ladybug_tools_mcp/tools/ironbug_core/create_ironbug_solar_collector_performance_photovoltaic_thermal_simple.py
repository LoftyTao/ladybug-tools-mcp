'MCP tool for IB_solar_collector_performance_photovoltaic_thermal_simple.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_solar_collector_performance_photovoltaic_thermal_simple tool.'

    @mcp.tool(
        name='IB_solar_collector_performance_photovoltaic_thermal_simple',
        description=(
