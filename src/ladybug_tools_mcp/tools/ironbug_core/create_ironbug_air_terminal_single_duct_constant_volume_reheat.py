...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            'AirTerminal:SingleDuct:ConstantVolume:Reheat. Use the returned '
            'target as a demand-side terminal unit, attach a reviewed '
            'reheat_coil_target when needed, and bind it to an IB_ThermalZone '
            'through thermal_zone_target or the ThermalZone tool. This is not '
            'zone equipment and not a Honeybee Energy HVAC template. Returns '
            'target, summary_view, persistence_receipt, and report for '
            'downstream DetailedHVAC assembly.'
            'This tool authors Ironbug DetailedHVAC input only; run Energy simulation with the standard Ladybug Tools MCP Energy workflow after DetailedHVAC is applied. '
        ),
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'air-terminal', 'terminal-unit', 'single-duct', 'constant-volume', 'reheat', 'thermal-zone', 'author'},
        timeout=20,
    )
    def create_ironbug_air_terminal_single_duct_constant_volume_reheat(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_AirTerminalSingleDuctConstantVolumeReheat object."),
        ],
        ...
        availability_schedule_target: Annotated[
            ...
            Field(description='Optional IB_Schedule target for AvailabilitySchedule; pass a target dict from a compatible detailed_hvac schedule tool or a same-model identifier. Schedule values above zero make the constant-volume reheat terminal available.'),
        ] = None,
        ...
        maximum_reheat_air_temperature: Annotated[
            float | None,
            Field(description='Optional MaximumReheatAirTemperature in degrees C for the constant-volume reheat terminal.'),
        ] = None,
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_AirTerminalSingleDuctConstantVolumeReheat field Name.'),
        ] = None,
        ...
        reheat_coil_target: Annotated[
            ...
            Field(
                description=(
                    "Optional IB_CoilHeatingWater target or same-model identifier "
                    "to attach through the reviewed Garden relationship as this "
                    "constant-volume terminal's child reheat coil."
                )
            ),
        ] = None,
        thermal_zone_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "bind this constant-volume reheat air terminal to after "
        ...
        heating_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "Parameter 'HeatingCoil' on IB_AirTerminalSingleDuctConstantVolumeReheat; "
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_AirTerminalSingleDuctConstantVolumeReheat',
        ...
        if reheat_coil_target is not None:
            child = set_ironbug_constant_volume_reheat_terminal_coil(
                garden_root=garden_root,
