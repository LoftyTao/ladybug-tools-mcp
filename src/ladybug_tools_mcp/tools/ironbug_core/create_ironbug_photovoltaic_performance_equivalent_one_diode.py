'MCP tool for IB_photovoltaic_performance_equivalent_one_diode.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_photovoltaic_performance_equivalent_one_diode tool.'

    @mcp.tool(
        name='IB_photovoltaic_performance_equivalent_one_diode',
        description=(
