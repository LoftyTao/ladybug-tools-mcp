...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'setpoint', 'control', 'temperature', 'air-loop', 'cooling', 'warmest', 'variable-flow', 'author'},
        timeout=20,
    )
    def create_ironbug_setpoint_manager_warmest_temperature_flow(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_SetpointManagerWarmestTemperatureFlow object."),
        ],
        ...
        maximum_setpoint_temperature: Annotated[
            float | None,
            Field(
                description="Optional maximum supply-air setpoint temperature in deg C."
            ),
        ] = None,
        minimum_setpoint_temperature: Annotated[
            float | None,
            Field(
                description="Optional minimum supply-air setpoint temperature in deg C."
            ),
        ] = None,
        strategy: Annotated[
            str | None,
            Field(description='Optional EnergyPlus strategy value for warmest-zone temperature reset.'),
        ] = None,
        minimum_turndown_ratio: Annotated[
            float | None,
            Field(description='Optional minimum supply-air flow turndown ratio used by SetpointManager:WarmestTemperatureFlow.'),
        ] = None,
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_SetpointManagerWarmestTemperatureFlow field Name.'),
        ] = None,
        overwrite: Annotated[
            bool,
        ...
        if minimum_turndown_ratio is not None:
            source_fields['MinimumTurndownRatio'] = minimum_turndown_ratio
        return create_source_backed_ironbug_object(
            garden_root=garden_root,
            ironbug_model_target=ironbug_model_target,
            source_class='IB_SetpointManagerWarmestTemperatureFlow',
