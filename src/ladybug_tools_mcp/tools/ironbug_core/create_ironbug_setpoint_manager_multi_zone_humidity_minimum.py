'MCP tool for detailed_hvac_setpoint_manager_multi_zone_humidity_minimum.'
...
def register(mcp: FastMCP) -> None:
    ...
    def create_ironbug_setpoint_manager_multi_zone_humidity_minimum(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_SetpointManagerMultiZoneHumidityMinimum object."),
        ],
        ...
        name: Annotated[
            str | None,
            Field(description='Optional EnergyPlus/OpenStudio object name; maps to Ironbug IB_SetpointManagerMultiZoneHumidityMinimum field Name.'),
        ] = None,
        overwrite: Annotated[
            bool,
        ...
        """Create an Ironbug SetpointManager:MultiZone:Humidity:Minimum target."""
        ...
        return create_source_backed_ironbug_object(
            ...
            source_class='IB_SetpointManagerMultiZoneHumidityMinimum',
