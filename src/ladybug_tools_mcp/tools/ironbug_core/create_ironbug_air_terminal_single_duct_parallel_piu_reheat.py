'MCP tool for detailed_hvac_air_terminal_single_duct_parallel_piu_reheat.'
...
def register(mcp: FastMCP) -> None:
    'Register the detailed_hvac_air_terminal_single_duct_parallel_piu_reheat tool.'

    @mcp.tool(
        name='air_terminal_single_duct_parallel_piu_reheat',
        description=(
            'Create IB_AirTerminalSingleDuctParallelPIUReheat, an Ironbug '
            'single-duct parallel powered induction unit (PIU) reheat air '
            'terminal that maps downstream to EnergyPlus/OpenStudio '
            'AirTerminal:SingleDuct:ParallelPIU:Reheat. Use the returned '
            'target as a fan-powered demand terminal, attach compatible fan '
            'and heating-coil child targets when needed, and bind it to an '
        ...
        tags={'ironbug', 'detailed-hvac', 'hvac', 'component', 'air-terminal', 'terminal-unit', 'single-duct', 'piu', 'parallel', 'reheat', 'thermal-zone', 'author'},
        timeout=20,
    )
    def create_ironbug_air_terminal_single_duct_parallel_piu_reheat(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_AirTerminalSingleDuctParallelPIUReheat object."),
        ],
        ...
        availability_schedule_target: Annotated[
            ...
            Field(description='Optional IB_Schedule target for AvailabilitySchedule; pass a target dict from a compatible detailed_hvac schedule tool or a same-model identifier. Schedule values above zero make the parallel PIU terminal available.'),
        ] = None,
        maximum_primary_air_flow_rate: Annotated[
            float | str | None,
            Field(description='Optional MaximumPrimaryAirFlowRate in m3/s, or an EnergyPlus autosizable literal accepted by Ironbug.'),
        ] = None,
        maximum_secondary_air_flow_rate: Annotated[
            float | str | None,
            Field(description='Optional MaximumSecondaryAirFlowRate in m3/s, or an EnergyPlus autosizable literal accepted by Ironbug.'),
        ] = None,
        ...
        fan_on_flow_fraction: Annotated[
            float | str | None,
            Field(description='Optional FanOnFlowFraction, the 0.0-1.0 primary-air fraction at which the parallel PIU fan turns on.'),
        ] = None,
        ...
        thermal_zone_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "bind this parallel PIU air terminal to after creation; "
        ...
        name: Annotated[
            str | None,
            Field(description='Optional Name value; maps to Ironbug IB_AirTerminalSingleDuctParallelPIUReheat field Name.'),
        ] = None,
        ...
        heating_coil_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "identifier for Parameter 'HeatingCoil' on the parallel PIU "
        ...
        fan_target: Annotated[
            ...
            Field(
                description=(
                    ...
                    "identifier for Parameter 'Fan' on the parallel PIU terminal."
                )
            ),
        ] = None,
        overwrite: Annotated[
        ...
        """Create IB_AirTerminalSingleDuctParallelPIUReheat as a reviewed parallel PIU terminal."""
        ...
        if maximum_secondary_air_flow_rate is not None:
            source_fields['MaximumSecondaryAirFlowRate'] = maximum_secondary_air_flow_rate
        ...
        if fan_on_flow_fraction is not None:
            source_fields['FanOnFlowFraction'] = fan_on_flow_fraction
        ...
        created = create_source_backed_ironbug_object(
            ...
            source_class='IB_AirTerminalSingleDuctParallelPIUReheat',
