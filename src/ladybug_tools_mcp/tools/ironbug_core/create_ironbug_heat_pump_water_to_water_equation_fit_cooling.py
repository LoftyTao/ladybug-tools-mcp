'MCP tool for IB_heat_pump_water_to_water_equation_fit_cooling.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_heat_pump_water_to_water_equation_fit_cooling tool.'

    @mcp.tool(
        name='IB_heat_pump_water_to_water_equation_fit_cooling',
        description=(
