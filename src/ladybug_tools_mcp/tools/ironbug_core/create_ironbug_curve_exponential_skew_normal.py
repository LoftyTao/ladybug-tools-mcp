"""MCP tool for ib_curveexponentialskewnormal."""
...
def register(mcp: FastMCP) -> None:
    """Register the IB_CurveExponentialSkewNormal tool."""

    @mcp.tool(
        name="IB_curve_exponential_skew_normal",
        description="Create IB_CurveExponentialSkewNormal, an OpenStudio/EnergyPlus Curve:ExponentialSkewNormal performance curve using exponential-modified skew-normal performance function. This tool authors Ironbug DetailedHVAC curve input only; it does not create equipment, loops, schedules, or run simulation. Returns target, summary_view, persistence_receipt, and report for downstream DetailedHVAC assembly.",
        tags={"ironbug", "detailed-hvac", "hvac", "component", "curve", "performance", "equation-fit", "author"},
        timeout=20,
    )
    def create_ironbug_curve_exponential_skew_normal(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the new IB_CurveExponentialSkewNormal object."),
        ],
        ...
        coefficient1_c1: Annotated[
            float | None,
            Field(description="C1 for Curve:ExponentialSkewNormal; maps to Ironbug field Coefficient1C1."),
        ] = None,
        coefficient2_c2: Annotated[
            float | None,
            Field(description="C2 for Curve:ExponentialSkewNormal; maps to Ironbug field Coefficient2C2."),
        ] = None,
        coefficient3_c3: Annotated[
            float | None,
            Field(description="C3 for Curve:ExponentialSkewNormal; maps to Ironbug field Coefficient3C3."),
        ] = None,
        coefficient4_c4: Annotated[
            float | None,
            Field(description="C4 for Curve:ExponentialSkewNormal; maps to Ironbug field Coefficient4C4."),
        ] = None,
        minimum_valueofx: Annotated[
            float | None,
            Field(description="Minimum x for Curve:ExponentialSkewNormal; maps to Ironbug field MinimumValueofx."),
        ] = None,
        maximum_valueofx: Annotated[
            float | None,
            Field(description="Maximum x for Curve:ExponentialSkewNormal; maps to Ironbug field MaximumValueofx."),
        ] = None,
        ...
        input_unit_typeforx: Annotated[
            str | None,
            Field(description="x input unit type for Curve:ExponentialSkewNormal; maps to Ironbug field InputUnitTypeforx."),
        ] = None,
        output_unit_type: Annotated[
            str | None,
            Field(description="output unit type for Curve:ExponentialSkewNormal; maps to Ironbug field OutputUnitType."),
        ] = None,
        name: Annotated[
            str | None,
            Field(description="Explicit OpenStudio/EnergyPlus object name for this Curve:ExponentialSkewNormal; maps to Ironbug field Name."),
        ] = None,
        ...
        coefficients: Annotated[
            list[float] | None,
            Field(description="Optional 4-value coefficient list in Curve:ExponentialSkewNormal field order, C1 through C4, as a compact alternative to individual coefficient inputs."),
        ] = None,
        overwrite: Annotated[
            bool,
        ...
        """Create IB_CurveExponentialSkewNormal as reviewed performance curve data."""
        ...
        if coefficients is not None:
            ...
            if len(coefficients) != len(coefficient_fields):
                raise ValueError("IB_CurveExponentialSkewNormal coefficients expects 4 values.")
            source_fields.update(dict(zip(coefficient_fields, coefficients)))
        return create_source_backed_ironbug_object(
            garden_root=garden_root,
            ironbug_model_target=ironbug_model_target,
            source_class="IB_CurveExponentialSkewNormal",
