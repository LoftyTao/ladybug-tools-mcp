'MCP tool for IB_coil_heating_gas_multi_stage_stage_data.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_coil_heating_gas_multi_stage_stage_data tool.'

    @mcp.tool(
        name='IB_coil_heating_gas_multi_stage_stage_data',
        description=(
