'MCP tool for IB_availability_manager_high_temperature_turn_on.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_availability_manager_high_temperature_turn_on tool.'

    @mcp.tool(
        name='IB_availability_manager_high_temperature_turn_on',
        description=(
