'MCP tool for IB_availability_manager_night_ventilation.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_availability_manager_night_ventilation tool.'

    @mcp.tool(
        name='IB_availability_manager_night_ventilation',
        description=(
