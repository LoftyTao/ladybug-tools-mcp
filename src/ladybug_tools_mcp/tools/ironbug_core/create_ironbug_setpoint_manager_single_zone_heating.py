'MCP tool for IB_setpoint_manager_single_zone_heating.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_setpoint_manager_single_zone_heating tool.'

    @mcp.tool(
        name='IB_setpoint_manager_single_zone_heating',
        description=(
