'MCP tool for IB_availability_manager_hybrid_ventilation.'
...
def register(mcp: FastMCP) -> None:
    'Register the IB_availability_manager_hybrid_ventilation tool.'

    @mcp.tool(
        name='IB_availability_manager_hybrid_ventilation',
        description=(
