"""Create an Ironbug chilled-water loop MCP tool."""
...
def register(mcp: FastMCP) -> None:
    'Register the detailed_hvac_plant_loop_chilled_water tool.'

    @mcp.tool(
        name="plant_loop_chilled_water",
        description=(
            "Create a reviewed chilled-water Ironbug loop from pump/source/load "
            "component targets. This is the public cooling-loop authoring path; "
        ...
        tags={"ironbug", "plant-loop", "chilled-water", "author"},
        timeout=20,
    )
    def create_ironbug_chilled_water_loop(
        ...
        identifier: Annotated[
            str,
            Field(description="Stable identifier for the chilled-water loop."),
        ],
        loop_name: Annotated[
            str | None,
        ...
        supply_branch_component_targets: Annotated[
            ...
            Field(
                description=(
                    "Ordered supply-side pump and cooling-source component targets "
        ...
        demand_branch_component_targets: Annotated[
            ...
            Field(
                description=(
                    "Ordered demand-side load or heat-exchanger component targets "
        ...
        setpoint_c: Annotated[
            float,
            Field(description="Chilled-water loop temperature setpoint in Celsius."),
        ] = 6.7,
        ...
        overwrite: Annotated[
            bool,
            Field(description="Replace an existing chilled-water loop with the same identifier."),
        ] = False,
    ) -> dict[str, Any]:
        """Create a chilled-water Ironbug loop."""
