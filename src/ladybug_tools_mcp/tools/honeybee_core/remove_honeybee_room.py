...
def register(mcp: FastMCP) -> None:
    ...
    def remove_honeybee_room(
        ...
        target: Annotated[
            dict[str, Any],
            Field(
                description='Required Honeybee room typed target from HB_search_model_objects; not a room identifier string.'
            ),
        ],
