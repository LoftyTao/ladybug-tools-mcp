...
def register(mcp: FastMCP) -> None:
    """Register the get_base_dragonfly_model tool."""

    @mcp.tool(
        name="get_base_dragonfly_model",
        description="Read the Garden base Dragonfly model target and minimal context. This is not a validation tool; use validate_dragonfly_model for validation flags or issue checks.",
        tags={"garden", "garden-mode", "dragonfly", "model", "base-dragonfly-model", "read", "safe"},
