...
def register(mcp: FastMCP) -> None:
    'Register the GD_set_base_honeybee_model tool.'

    @mcp.tool(
        name='GD_set_base_honeybee_model',
        description=(
            ...
            "Honeybee create tool, GD_list_models, or another base-model "
        ...
        garden_root: Annotated[
            ...
            Field(
                description=(
                    ...
                    "GD_create['garden_root']; set the Honeybee base-model "
