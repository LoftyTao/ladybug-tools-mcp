...
EXPLICIT_LOCAL_TOOL_NAMES: dict[str, str] = {
    ...
    "create_dragonfly_model": "model",
    "create_dragonfly_room2d": "room2d",
    "create_dragonfly_story": "story",
    "create_dragonfly_building": "building",
    "create_dragonfly_building_from_footprint": "building_from_footprint",
    "create_dragonfly_context_shade": "context_shade",
    "search_dragonfly_model_objects": "search_objects",
    "query_dragonfly_room2ds_by_attribute": "room2ds_by_attribute",
    "get_dragonfly_geometry_properties": "geometry_properties",
    "validate_dragonfly_model": "validate_model",
    ...
    "create_thermal_connector": "thermal_connector",
    "export_model_to_des": "export_model",
