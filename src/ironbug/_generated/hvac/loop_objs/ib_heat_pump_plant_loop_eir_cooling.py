...
class IB_HeatPumpPlantLoopEIRCooling(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_HeatPumpPlantLoopEIRCooling'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_HeatPumpPlantLoopEIRCooling.cs'
    ...
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_HeatPumpPlantLoopEIRCooling_FieldSet'
    ...
    SOURCE_FIELD_NAMES: ClassVar[tuple[str, ...]] = (
        ...
        'MaximumHeatRecoveryOutletTemperature',
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        ...
        'MaximumHeatRecoveryOutletTemperature': 'float',
    ...
    type: Literal['IB_HeatPumpPlantLoopEIRCooling'] = PydanticField(default='IB_HeatPumpPlantLoopEIRCooling')
