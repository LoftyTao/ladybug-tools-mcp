...
class IB_FluidCoolerTwoSpeed(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_FluidCoolerTwoSpeed'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_FluidCoolerTwoSpeed.cs'
    ...
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_FluidCoolerTwoSpeed_FieldSet'
    ...
    type: Literal['IB_FluidCoolerTwoSpeed'] = PydanticField(default='IB_FluidCoolerTwoSpeed')
