...
class IB_CoolingTowerSingleSpeed(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_CoolingTowerSingleSpeed'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_CoolingTowerSingleSpeed.cs'
    ...
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_CoolingTowerSingleSpeed_FieldSet'
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        'AirFlowRateinFreeConvectionRegime': 'float',
        ...
        'FanPoweratDesignAirFlowRate': 'float',
        'FreeConvectionAirFlowRateSizingFactor': 'float',
        'FreeConvectionCapacity': 'float',
        ...
        'SizingFactor': 'float',
        'UFactorTimesAreaValueatDesignAirFlowRate': 'float',
        'UFactorTimesAreaValueatFreeConvectionAirFlowRate': 'float',
    }
    ...
    type: Literal['IB_CoolingTowerSingleSpeed'] = PydanticField(default='IB_CoolingTowerSingleSpeed')
