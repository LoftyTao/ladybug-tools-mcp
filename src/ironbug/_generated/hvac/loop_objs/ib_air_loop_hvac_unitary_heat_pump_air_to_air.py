...
class IB_AirLoopHVACUnitaryHeatPumpAirToAir(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_AirLoopHVACUnitaryHeatPumpAirToAir'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_AirLoopHVACUnitaryHeatPumpAirToAir.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_AirLoopHVACUnitary',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_AirLoopHVACUnitaryHeatPumpAirToAir_FieldSet'
    ...
    type: Literal['IB_AirLoopHVACUnitaryHeatPumpAirToAir'] = PydanticField(default='IB_AirLoopHVACUnitaryHeatPumpAirToAir')
