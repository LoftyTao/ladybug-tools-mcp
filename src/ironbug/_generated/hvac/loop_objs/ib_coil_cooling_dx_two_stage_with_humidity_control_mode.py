...
class IB_CoilCoolingDXTwoStageWithHumidityControlMode(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_CoilCoolingDXTwoStageWithHumidityControlMode'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_CoilCoolingDXTwoStageWithHumidityControlMode.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_CoilDX',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_CoilCoolingDXTwoStageWithHumidityControlMode_FieldSet'
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        ...
        'NumberofCapacityStages': 'int',
        'NumberofEnhancedDehumidificationModes': 'int',
    }
    ...
    type: Literal['IB_CoilCoolingDXTwoStageWithHumidityControlMode'] = PydanticField(default='IB_CoilCoolingDXTwoStageWithHumidityControlMode')
