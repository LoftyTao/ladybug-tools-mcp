...
class IB_CoilCoolingWater(IronbugSourceMixin, IronbugModelObjectBase):
    ...
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_CoilCoolingWater_FieldSet'
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        ...
        'DesignInletAirHumidityRatio': 'float',
        'DesignInletAirTemperature': 'float',
        'DesignInletWaterTemperature': 'float',
        'DesignOutletAirHumidityRatio': 'float',
        'DesignOutletAirTemperature': 'float',
        'DesignWaterFlowRate': 'float',
        'HeatExchangerConfiguration': 'str',
        'TypeOfAnalysis': 'str',
    }
    ...
    type: Literal['IB_CoilCoolingWater'] = PydanticField(default='IB_CoilCoolingWater')
