...
class IB_EvaporativeFluidCoolerSingleSpeed(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_EvaporativeFluidCoolerSingleSpeed'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_EvaporativeFluidCoolerSingleSpeed.cs'
    ...
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_EvaporativeFluidCoolerSingleSpeed_FieldSet'
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        ...
        'SizingFactor': 'float',
        'StandardDesignCapacity': 'float',
        'UfactorTimesAreaValueatDesignAirFlowRate': 'float',
        'UserSpecifiedDesignCapacity': 'float',
    }
    ...
    type: Literal['IB_EvaporativeFluidCoolerSingleSpeed'] = PydanticField(default='IB_EvaporativeFluidCoolerSingleSpeed')
