...
class IB_HeaderedPumpsVariableSpeed(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_HeaderedPumpsVariableSpeed'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/LoopObjs/IB_HeaderedPumpsVariableSpeed.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_Pump',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_HeaderedPumpsVariableSpeed_FieldSet'
    ...
    type: Literal['IB_HeaderedPumpsVariableSpeed'] = PydanticField(default='IB_HeaderedPumpsVariableSpeed')
