...
class IB_TopField(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_TopField'
    ...
    type: Literal['IB_TopField'] = PydanticField(default='IB_TopField')
