...
class IB_AirTerminalSingleDuctSeriesPIUReheat(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_AirTerminalSingleDuctSeriesPIUReheat'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/AirTerminals/IB_AirTerminalSingleDuctSeriesPIUReheat.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_AirTerminal',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_AirTerminalSingleDuctSeriesPIUReheat_FieldSet'
    ...
    type: Literal['IB_AirTerminalSingleDuctSeriesPIUReheat'] = PydanticField(default='IB_AirTerminalSingleDuctSeriesPIUReheat')
