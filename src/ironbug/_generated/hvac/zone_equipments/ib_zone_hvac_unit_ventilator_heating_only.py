...
class IB_ZoneHVACUnitVentilator_HeatingOnly(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_ZoneHVACUnitVentilator_HeatingOnly'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/ZoneHVAC/IB_ZoneHVACUnitVentilator_HeatingOnly.cs'
    ...
    type: Literal['IB_ZoneHVACUnitVentilator_HeatingOnly'] = PydanticField(default='IB_ZoneHVACUnitVentilator_HeatingOnly')
