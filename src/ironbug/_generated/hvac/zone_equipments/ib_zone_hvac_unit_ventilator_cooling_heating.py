...
class IB_ZoneHVACUnitVentilator_CoolingHeating(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_ZoneHVACUnitVentilator_CoolingHeating'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/ZoneHVAC/IB_ZoneHVACUnitVentilator_CoolingHeating.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_ZoneEquipment',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_ZoneHVACUnitVentilator_FieldSet'
    ...
    type: Literal['IB_ZoneHVACUnitVentilator_CoolingHeating'] = PydanticField(default='IB_ZoneHVACUnitVentilator_CoolingHeating')
