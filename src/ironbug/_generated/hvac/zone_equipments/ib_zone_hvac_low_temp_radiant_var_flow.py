...
class IB_ZoneHVACLowTempRadiantVarFlow(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_ZoneHVACLowTempRadiantVarFlow'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/ZoneHVAC/IB_ZoneHVACLowTempRadiantVarFlow.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_ZoneEquipment',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_ZoneHVACLowTempRadiantVarFlow_FieldSet'
    ...
    type: Literal['IB_ZoneHVACLowTempRadiantVarFlow'] = PydanticField(default='IB_ZoneHVACLowTempRadiantVarFlow')
