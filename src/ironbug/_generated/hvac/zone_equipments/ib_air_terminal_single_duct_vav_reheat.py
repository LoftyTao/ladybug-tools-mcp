...
class IB_AirTerminalSingleDuctVAVReheat(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_AirTerminalSingleDuctVAVReheat'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/AirTerminals/IB_AirTerminalSingleDuctVAVReheat.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_AirTerminal',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_AirTerminalSingleDuctVAVReheat_FieldSet'
    ...
    SOURCE_FIELD_TYPES: ClassVar[dict[str, str]] = {
        ...
        'DamperHeatingAction': 'str',
        'FixedMinimumAirFlowRate': 'float',
        'MaximumAirFlowRate': 'float',
        'MaximumFlowFractionDuringReheat': 'float',
        'MaximumFlowPerZoneFloorAreaDuringReheat': 'float',
        'MaximumHotWaterOrSteamFlowRate': 'float',
        'MaximumReheatAirTemperature': 'float',
        'MinimumHotWaterOrStreamFlowRate': 'str | float | int | bool',
        'ZoneMinimumAirFlowInputMethod': 'str',
        'ZoneMinimumAirFlowMethod': 'str | float | int | bool',
    }
    ...
    type: Literal['IB_AirTerminalSingleDuctVAVReheat'] = PydanticField(default='IB_AirTerminalSingleDuctVAVReheat')
