...
class IB_ZoneHVACPackagedTerminalAirConditioner(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_ZoneHVACPackagedTerminalAirConditioner'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/ZoneHVAC/IB_ZoneHVACPackagedTerminalAirConditioner.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_ZoneEquipment',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_ZoneHVACPackagedTerminalAirConditioner_FieldSet'
    ...
    type: Literal['IB_ZoneHVACPackagedTerminalAirConditioner'] = PydanticField(default='IB_ZoneHVACPackagedTerminalAirConditioner')
