...
class IB_ZoneHVACPackagedTerminalHeatPump(IronbugSourceMixin, IronbugModelObjectBase):
    SOURCE_CLASS: ClassVar[str] = 'IB_ZoneHVACPackagedTerminalHeatPump'
    SOURCE_PATH: ClassVar[str] = 'src/Ironbug.HVAC/ZoneEquipments/ZoneHVAC/IB_ZoneHVACPackagedTerminalHeatPump.cs'
    SOURCE_NAMESPACE: ClassVar[str] = 'Ironbug.HVAC'
    SOURCE_BASES: ClassVar[tuple[str, ...]] = (
        'IB_ZoneEquipment',
    )
    SOURCE_INTERFACES: ClassVar[tuple[str, ...]] = ()
    SOURCE_FIELD_SET: ClassVar[str | None] = 'IB_ZoneHVACPackagedTerminalHeatPump_FieldSet'
    ...
    type: Literal['IB_ZoneHVACPackagedTerminalHeatPump'] = PydanticField(default='IB_ZoneHVACPackagedTerminalHeatPump')
