...
1. Create the new Room with `HB_create_room`.
2. Run `HB_relate_model`, usually `relation_mode="explicit_relate_full"` for complex live expansions.
...
- `HB_validate_model.is_valid == true`.
