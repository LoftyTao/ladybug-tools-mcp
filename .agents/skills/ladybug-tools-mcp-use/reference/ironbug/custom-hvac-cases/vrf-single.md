...
- Prompt: `对 Room1 添加 VRF 空调系统。`
- Keywords: Room1, VRF, variable refrigerant flow
...
2. Create VRF cooling DX coil.
3. Create VRF heating DX coil.
4. Create OnOff fan.
5. Create VRF terminal unit with cooling coil, heating coil, fan, and
   ThermalZone.
6. Create VRF root with `terminals_targets=[terminal]`.
...
Do not create DOAS, AirLoopHVAC, PlantLoop, or NoAirLoop.
